...
import "./custom css/InputSpinNon.css";
import "./custom css/Toast.css";
import CloudUploadIcon from "@mui/icons-material/CloudUpload";
import toast from "react-hot-toast";
import { Domain, Done } from "@mui/icons-material";
...
function AddnewEmp() {
  ...
  const validatePassword = (password) => {
    ...
    return lengthValid && specialCharValid && uppercaseValid;
  };
  ...
  const handleInputChange1 = (e) => {
    ...
    if (name === "birthdate") {
      ...
      setEmployee((prevEmployee) => ({
        ...prevEmployee,
        password: `Qsis@${dob.getFullYear()}`, // Set password when birthdate changes
      }));
    }
  ...
  const handleAddEmp = useCallback(
    async (employee) => {
      ...
      try {
        const result = await axios.post("/employees", employee, {
          headers: {
              ...
              <div className="w-1/2 max-lg:w-full max-lg:border-none h-full border-r p-5 gap-5 max-lg:grid max-lg:grid-cols-2 max-md:flex flex flex-col">
                ...
                <div className="flex flex-col w-full gap-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`h-14 px-5 rounded-md shadow-[0_0_5px_0] shadow-gray-300 font-medium text-lg text-[#444444]  ${
                      errors.branch ? "!border-red-500 border-2" : ""
                    }`}
                  />
                  {errors.branch && (
